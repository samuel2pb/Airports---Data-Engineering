...
Essa solução funciona da seguinte forma, a ferramenta captura o Delta (Incremento) dos bancos transacionais e guarda esses registros compactados em uma camada RAW numa cloud pública.
...
As tecnologias chave deste processo são um bucket numa Cloud Pública, um CDC, um Data Warehouse, Airflow e Spark. Veja que citei os primeiros três de forma genérica pois podem ser implementados utilizando diversas ferramentas. As justificativas para o uso do CDC é sua praticidade e custo benefício, onde 100GB de transferência incremental mensais custariam aproximadamente 150 USD, isso significa também que para as necessidades de escalabilidade funcionaria muito bem com rotinas mais frequentes do Airflow e Spark, tendo inclusive capacidade de fornecimento de dados em tempo real. 
...
Uma Camada de Consumo é a base de toda estretégia para o Business Inteligence ser implementado.
